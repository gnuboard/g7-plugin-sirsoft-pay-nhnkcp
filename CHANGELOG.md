...
- 상품의 기본 통화와 다른 통화로 결제할 때(예: 엔화 상품을 원화로 결제) 결제창 청구 금액과 승인 확인 금액의 통화 기준이 어긋나 "결제 금액이 일치하지 않습니다"로 막히던 문제를 수정했습니다. 결제 승인·결제창 닫힘 확인이 고객이 선택한 결제 통화 기준으로 일관되게 검증됩니다.

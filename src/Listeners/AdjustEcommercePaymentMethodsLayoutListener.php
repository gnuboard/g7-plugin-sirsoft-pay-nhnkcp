...
/**
 * 이커머스 결제수단 설정 화면에 NHN KCP 테스트모드 경고를 주입한다.
 *
...
class AdjustEcommercePaymentMethodsLayoutListener implements HookListenerInterface
{
    ...
    private const TEST_MODE_DATA_SOURCE_ID = 'nhnkcp_test_mode_status';

    private const TEST_MODE_NOTICE_ID = 'payment_test_mode_order_settings_notice';

    private const TEST_MODE_NOTICE_ROW_ID = 'nhnkcp_test_mode_order_settings_notice';
    ...
    private const TEST_MODE_CONDITION = 'nhnkcp_test_mode_status.data?.is_test_mode === true';
    ...
    private function ensureTestModeDataSource(array $layout): array
    {
        ...
        $dataSources[] = [
            ...
            'label_key' => '$t:sirsoft-pay_nhnkcp.editor.data_source.nhnkcp_test_mode_status',
            'type' => 'api',
            'endpoint' => '/api/plugins/sirsoft-pay_nhnkcp/admin/settings/test-mode-status',
            'method' => 'GET',
    ...
    /**
     * 안내 컨테이너에 NHN KCP 테스트 모드 안내 행을 중복 없이 추가합니다.
     *
    ...
    /**
     * NHN KCP 테스트 모드 안내 문구와 설정 이동 버튼으로 구성된 행 노드 정의를 반환합니다.
     *
                ...
                [
                    ...
                    'children' => [
                        [
                            ...
                            'text' => '$t:sirsoft-pay_nhnkcp.admin.test_mode_settings_warning_plugin',
                        ],
                        [
                            'type' => 'basic',
                            'name' => 'P',
                            ...
                            'text' => '$t:sirsoft-pay_nhnkcp.admin.test_mode_settings_warning_body',
                        ],
                    ],
                ],
                [
                    ...
                    'actions' => [
                        [
                            ...
                            'handler' => 'navigate',
                            'params' => [
                                'path' => '/admin/plugins/sirsoft-pay_nhnkcp/settings',
                            ],
                        ],
                    ],
                    'children' => [
                        [
                            'type' => 'basic',
                            'name' => 'Span',
                            'text' => '$t:sirsoft-pay_nhnkcp.admin.test_mode_settings_warning_action',
                        ],
                    ],
                ],
            ],
